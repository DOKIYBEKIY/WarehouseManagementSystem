...
<form method="post" action="${pageContext.request.contextPath}/stock/out/save" class="mt-12">
...
<div class="form-group"><label>出库数量</label><input type="number" name="quantity" min="1" required></div>
<div class="form-group"><label>出库单价</label><input type="number" step="0.01" name="unitPrice" required></div>
<div class="form-group"><label>备注</label><input type="text" name="remark"></div>
<button type="submit" class="btn btn-primary">保存</button>
<a class="btn btn-outline" href="${pageContext.request.contextPath}/stock/out/list">返回</a>
</form>
</div>
